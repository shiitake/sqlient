...
module ServerConnection = 
    ...
    //let connString = "Server=myserver;database=mydb;User ID=dbuser;Password=mypass123;Trusted_Connection=False;Encrypt=False;Connection Timeout=30;"
    ...
    let buildConnString request =
        ...
        builder.DataSource <- request.servername
